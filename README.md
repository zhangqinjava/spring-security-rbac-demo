# 本项目是一个高性能、高可用的后台权限管理系统核心框架。它采用了当前企业级Java开发的主流技术栈，以Spring Boot为基础，深度融合Spring Security安全框架，实现了基于RBAC（角色基于访问控制） 的精细权限模型，并使用JWT（JSON Web Token） 作为无状态认证机制，数据持久化则由关系型数据库MySQL承担。
## 1.核心特性与技术实现：
Spring Boot快速开发框架：
